...
```json
{
  "plugins": ["data-model-command"]
}
```

## Author

Keyvan Arasteh <keyvan.arasteh@live.com>

## Repository

https://github.com/keyvanarasteh/opencode-data-model-command
